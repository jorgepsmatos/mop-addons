...
L["Adjust the maximum width of the bags, relative to screen size.\nNote: due to the layout constraints, this is a soft cap."] = true
L["Anchored"] = true
...
L["Allow you manually redefine the section in which an item should be put. Simply drag an item on the section title."] = "允许以手动方式，将物品拖曳至区块标题来分类物品" -- Needs review
...
L["As soon as possible"] = "及早"
L["At mechants', bank, auction house, ..."] = "在商人,银行,拍卖场等..."
L["Automatically open the bags at merchant's, bank, ..."] = "在商户，银行，自动打开袋..."
L["Automatic layout update"] = "自动布局更新"
L["Backpack"] = "背包"
...
L["Money"] = "金钱"
L["Move items from and to the bank by right-clicking on section headers."] = "移动项目物品及银行通过右键单击进行分类。"
L["Never"] = "从不"
L["New"] = "新物品"
...
L["Not at merchants', bank, ..."] = "不是商人，银行，..."
...
L["Press Alt while doing so to open a dropdown menu."] = "按下Alt键，而这样做，打开一个下拉菜单。" -- Needs review
L["Priority"] = "优先级"
...
L["Select how the bags are positionned."] = "选择袋的位置"
...
L["Select the top objective of the layout algorithm."] = "选择顶部的布局演算的目标。"
L["Select which bags AdiBags should display."] = "选择那个袋作为AdiBags显示"
...
L["Text"] = "文本"
L["Texture"] = "材质"
L["This setting allows to tone down what some people calls \"section dancing\" when moving/selling/milling items."] = "此设置可以淡化一些人所谓的“一节舞(section dancing)”时，移动/销售/milling 项目。"
L["Tidy bags"] = "整理背包"
...
L["When checked, right-clicking on an empty space of a bag opens the configuration panel."] = "检阅时，在包的空白处点击右键，打开配置面板。"
...
L["Bank color"] = "Cor do banco" -- Needs review
...
L["Hide zeroes"] = "Esconder zeros" -- Needs review
...
L["Nothing to sell."] = "Nada para vender." -- Needs review
...
L["Only when required"] = "Somente quando requerido" -- Needs review
L["Opacity"] = "Opacidade"
L["Open automatically"] = "Abrir automaticamente" -- Needs review
